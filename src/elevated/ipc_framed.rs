...
use crate::ResolvedWindowsSandboxPermissions;
use anyhow::Result;
...
mod tests {
    ...
    #[test]
    fn spawn_request_serializes_permissions() {
        let msg = FramedMessage {
            version: IPC_PROTOCOL_VERSION,
        ...
        assert_eq!(true, encoded["payload"]["permissions"]["block_network"]);
        ...
        assert_eq!(
            ResolvedWindowsSandboxPermissions::read_only(true),
            payload.permissions
        );
        assert_eq!(
