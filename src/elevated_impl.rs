...
pub struct ElevatedSandboxCaptureRequest<'a> {
    pub permissions: &'a crate::ResolvedWindowsSandboxPermissions,
    ...
    /// Forward output to this process' stdout/stderr as frames arrive.
    pub stream_output: bool,
    /// Retain output bytes in the returned [`crate::CaptureResult`].
...
pub use windows_impl::run_windows_sandbox_capture_elevated;
...
#[cfg(not(target_os = "windows"))]
pub use stub::run_windows_sandbox_capture_elevated;
